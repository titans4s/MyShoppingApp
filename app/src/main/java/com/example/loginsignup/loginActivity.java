...
import com.example.loginsignup.Model.Users;
import com.example.loginsignup.Prevalent.Prevalent;
                    ...
                    if (usersData.getUsername().equals(name)) {
                        if (usersData.getPassword().equals(password)) {
                            ...
                            if(parentDbName.equals("Admins"))
                            {
                              ...
                              //  Intent intent = new Intent(loginActivity.this, AdminPanelinterface.class);
                              //  startActivity(intent);
                            }
