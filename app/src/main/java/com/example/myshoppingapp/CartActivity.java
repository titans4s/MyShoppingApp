...
import com.example.myshoppingapp.Model.Cart;
import com.example.myshoppingapp.Prevalent.Prevalent;
import com.example.myshoppingapp.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(@NonNull DataSnapshot datasnapshot) {
                if(datasnapshot.exists())
                {
                    ...
                    if(shippingState.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Congratulations your final product has been shipped successfully.Soon you will receive your order at your door step");
