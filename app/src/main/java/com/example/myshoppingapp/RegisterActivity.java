...
public class RegisterActivity extends AppCompatActivity {
  ...
  //  private ProgressDialog loadingBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputEmail = (EditText) findViewById(R.id.register_mail_input);
    ...
    private void CreateAccount()
    {
        ...
        else
        {
            ...
            ValidateUname(name, email, password);
        }
    }


    private void ValidateUname(final String name, final String email, final String password)
    {
